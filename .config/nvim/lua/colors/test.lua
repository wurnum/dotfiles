...
local set_groups = function()
  local groups = {
    ...
    NormalNC        = { fg = c.fg, bg = cfg.transparent and c.none or c.bg },
    ...
    Conceal         = { fg = c.gray05 },
    Cursor          = { fg = c.cyan, bg = c.none, style = "reverse" },
    CursorIM        = { fg = c.cyan, bg = c.none, style = "reverse" },
    Directory       = { fg = c.blue, bg = c.none, style = "bold" },
    DiffAdd         = { fg = c.bright_green, bg = c.none, style = "reverse" },
    DiffChange      = { fg = c.bright_blue, bg = c.none, style = "reverse" },
    DiffDelete      = { fg = c.bright_red, bg = c.none, style = "reverse" },
    DiffText        = { fg = c.fg, bg = c.none, style = "reverse" },
    ErrorMsg        = { fg = c.red },
